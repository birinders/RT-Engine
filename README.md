...
This has reduced computational times by over 10x for more complicated scenes (exact figures may vary by your CPU cores), and over 6x for lesser populated scenes! Exact speedups will be posted in a few days for some of the renders displayed below.
